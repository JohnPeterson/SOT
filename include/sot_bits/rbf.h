...
namespace sot {
    ...
    class Kernel {
        ...
        virtual inline int order() const
        {
          return 0;
        }
        /*!< \returns Order of the kernel */
        //! Method for getting the value of the kernel at 0
        virtual inline int phiZero() const
        {
          return 0;
        }
        /*!< \returns Value of kernel at 0 */
         ...
         */
        virtual inline double eval(double dist) const
        {
          return 0;
        }
         ...
         */
        virtual inline double deriv(double dist) const
        {
          return 0;
        }
         ...
         */
        virtual inline mat eval(const mat &dists) const
        {
          return mat();
        }
         ...
         */
        virtual inline mat deriv(const mat &dists) const
        {
          return mat();
        }
    };
    ...
    class Tail {
         ...
         */
        virtual inline int dimTail(int dim) const
        {
          return 0;
        }
         ...
         */
        virtual inline vec eval(const vec &point) const
        {
          return 0;
        }
         ...
         */
        virtual inline mat eval(const mat &points) const
        {
          return mat();
        }
         ...
         */
        virtual inline mat deriv(const vec &point) const
        {
          return mat();
        }
    };
